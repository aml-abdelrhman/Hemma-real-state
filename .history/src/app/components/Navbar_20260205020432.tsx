...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-11 left-1/2 -translate-x-1/2 w-[1311px] h-20 flex justify-between items-center px-0 gap-[213px] z-20 transition-all ${
      scrolled ? 'bg-gray-200/70 backdrop-blur-sm' : ''
    }`}>
      {/* Logo */}
      <div className="absolute left-[1131px] top-2 w-[180px] h-[60px] bg-white flex items-center justify-center rounded-md">
        <Image
