...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-15 left-4 max-w-[371px] h-[80px]  px-5 py-7 z-50 bg-[#C1C2C266] backdrop-blur-[50px]  md:bg-transparent md:top-10 md:left-25 flex items-center justify-between px-5 py-7 md:px-10 md:py-3 md:max-w-[1311px]">
