...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-10 z-50   rounded-[20px] bg-[#C1C2C266] backdrop-blur-[50px] px-5 py-7 flex items-center justify-between md:bg-transparent md:w-full md:max-w-[1311px]">
