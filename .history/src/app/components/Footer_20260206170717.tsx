    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative h-[320px] md:h-[378px]">
          ...
          {/* Content Box */}
          <div className="absolute bottom-0 left-0 w-full z-30 px-4 py-6 text-white opacity-90">
              ...
              <p className="text-sm md:text-base leading-relaxed mb-4">
                {locale === "ar" ? (
                  <>
                    ...
                    قاعدة بيانات واسعة وفريق خبراء لترويج المشاريع بشكل فعال وجذاب.
                  </>
                ) : (
                  <>
      ...
      {/* ================= BOTTOM FOOTER ================= */}
      <div className="absolute bottom-0 left-0 w-full px-4 py-6 z-40">
