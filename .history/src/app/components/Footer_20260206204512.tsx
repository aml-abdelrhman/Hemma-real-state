...
const FooterCustom: React.FC = () => {
    ...
    >
      ...
      <div className="grid grid-cols-1  md:grid-cols-2">
        ...
        <div className="relative md:h-[378px] h-auto">
          ...
          <div className="md:absolute w-full relative left-4 right-4 md:left-10 md:top-10 md:p-6 p-2">
                      ...
                      <p className="text-[20px] md:text-[16px] font-normal leading-relaxed mb-4">
                        {locale === "ar" ? (
                          <>
                            ...
                            بيانات واسعة <br /> للعملاء وفريق خبراء لترويج المشاريع بشكل فعال وجذاب، ومخصص لتلبية احتياجات العملاء
                          </>
                        ) : (
                          <>
  ...
  relative md:absolute md:bottom-10 md:left-0 w-full md:px-20 md:py-0 z-40 ">
      ...
      <path d="M12 7.2C9.8 7.2 8 9 8 11.2C8 13.4 9.8 15.2 12 15.2C14.2 15.2 16 13.4 16 11.2C16 9 14.2 7.2 12 7.2ZM12 14C10.6 14 9.6 13 9.6 11.6C9.6 10.2 10.6 9.2 12 9.2C13.4 9.2 14.4 10.2 14.4 11.6C14.4 13 13.4 14 12 14Z" fill="white"/>
...
<div className="flex flex-wrap justify-center gap-4 order-2 md:order-3 items-center">
  <span className="order-2 md:order-3">رقم الدائرة / الخدمة: 920014659</span>
  {/* Links */}
  <div className="flex gap-3 order-1 md:order-4">
