...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-10 w-full z-50 rounded-[20px] bg-[#C1C2C266] backdrop-blur-[50px] md:bg-transparent px-4 md:px-0 py-7 flex items-center justify-between md:max-w-[1311px]">
