            ...
            <p className="text-[20px] md:text-[16px] font-normal leading-relaxed mb-4">
              {locale === "ar" ? (
                <>
                  ...
                  قاعدة بيانات واسعة <br /> للعملاء وفريق خبراء لترويج المشاريع
                  بشكل فعال وجذاب، ومخصص لتلبية احتياجات العملاء
                </>
              ) : (
                <>
                  Hemma Real Estate excels in modern marketing, leveraging a
                  vast database and an expert team.
                </>
              )}
            </p>
          ...
          <div className="flex items-center gap-2 order-4 md:order-1">
            ...
            <a href="#" className="hover:opacity-80 transition-opacity">
              ...
              >
                ...
                />
                <path
                  d="M5.88135 17.1688L10.6146 12.4356M10.6146 12.4356L5.88135 5.88135H9.01676L12.4356 10.6146"
                  stroke="white"
                  strokeWidth="0.940625"
                />
              </svg>
