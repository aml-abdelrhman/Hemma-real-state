...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-10 left-25 w-full z-50 bg-transparent flex items-center justify-between md:max-w-[1311px]">
      ...
      {/* ================= Desktop Navbar ================= */}
      <div className="hidden md:flex flex-1 items-center justify-between bg-gray-200/40 backdrop-blur-[25px] rounded-2xl px-8 py-3 md:py-8 md:max-w-[945px] md:h-[80px] ">
