...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-transparent px-4 md:px-10 py-3 flex items-center justify-between">
      ...
      {/* ================= Desktop Navbar ================= */}
<div className=" hidden md:flex flex-1 items-center justify-center flex-nowrap gap-8 bg-gray-200/40 backdrop-blur-[25px] rounded-2xl px-7 py-3 md:w-[945px] md:h-[80px] max-w-[px] " >
        {/* Links */}
        {navLinks.map(link => (
<Link
  key={link.key}
