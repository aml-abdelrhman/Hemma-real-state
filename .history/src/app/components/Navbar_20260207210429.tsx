...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-10 left-25 max-w-[96px] h-[32px] z-50  bg-[#C1C2C266] backdrop-blur-[50px]  md:bg-transparent flex items-center justify-between px-5 py-7 md:px-10 md:py-3 md:max-w-[1311px]">
