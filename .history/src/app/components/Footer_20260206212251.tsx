...
const FooterCustom: React.FC = () => {
  ...
  return (
    ...
    >
      {/* ================= TOP SECTION ================= */}
      <div className="grid grid-cols-1  md:grid-cols-2 min-h-[200px] md:min-h-[378px]">
        {/* Image 1 */}
        ...
        <div className="relative md:h-[378px] h-auto">
          ...
          <div className="md:absolute w-full relative left-4 right-4 md:left-10 md:top-10 md:p-6 p-3">
