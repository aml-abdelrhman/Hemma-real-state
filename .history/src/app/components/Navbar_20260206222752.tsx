...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-11 leftmax-w-[1311px]  max-w-[1311px] h-20 flex justify-between items-center px-0 gap-[213px] z-20 transition-all }`}>
      {/* Logo */}
      <div className="absolute w-[96px] h-[32px] top-2 md:w-[180px] md:h-[60px] bg-white flex items-center justify-center rounded-md">
        <Image
          src={'/images/logo.png'}
          alt="Logo"
    fill
