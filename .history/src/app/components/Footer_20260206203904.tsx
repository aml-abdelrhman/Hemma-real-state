...
const FooterCustom: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1  md:grid-cols-2">
        ...
        {/* Image 2 + Content */}
        <div className="relative md:h-[378px] h-[378px]">
          <Image
            src="/images/footer2.png"
            alt="Footer Image 2"
            fill
            className="object-cover object-[top_-20%]  scale-y-[-1]"
            priority
          />
          <div
            className="absolute inset-0"
  ...
  relative md:absolute md:bottom-5 md:left-0 w-full md:px-20 md:py-0 z-40 ">
