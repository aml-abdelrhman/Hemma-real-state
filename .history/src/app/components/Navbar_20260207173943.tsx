...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-transparent px-4 md:px-10 py-3 flex items-center justify-between">
      ...
      {/* ================= Desktop Navbar ================= */}
<div className=" hidden md:flex flex-1 items-center justify-center flex-nowrap gap-8 bg-gray-200/40 backdrop-blur-[25px] rounded-2xl px-8 py-3 md:w-[945px] md:h-[80px] max-w-[1100px] " >
        {/* Links */}
        {navLinks.map(link => (
          <Link
            key={link.key}
            href={link.href}
            className="whitespace-nowrap text-[16px] font-medium text-white hover:text-gray-200 transition"
          >
            {link.label}
             <span
      className="
    ...
    >
      ...
      >
        <path
          d="M28.25 0C15 0 13.25 13 0 13H56.5C43.25 13 41.5 0 28.25 0Z"
          fill="white"
        />
      </svg>
    </span>
        ...
        {/* Separator */}
        <div className="h-6 w-px bg-white/60 mx-3" />
