...
<div className="absolute inset-0" style={{ background: "linear-gradient(270deg, rgba(171,149,126,0) 92.88%, #AB957E 100%)", }} /> </div>
        ...
        <div className="relative h-[320px] md:h-auto">
          <Image
            ...
            priority
          />
className="absolute inset-0 " style={{ background: linear-gradient(0deg, #AB957E 8.45%, rgba(171,149,126,0) 63.87%), linear-gradient(90deg, #AB957E 0%, rgba(171,149,126,0) 30%), linear-gradient(90deg, rgba(171,149,126,0) 70%, #AB957E 100%) , }} />
          {/* Content Box */}
