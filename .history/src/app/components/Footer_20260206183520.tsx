    ...
    >
      ...
      <div className="grid grid-cols-1  md:grid-cols-2">
        ...
        <div className="relative h-[320px] md:h-[378px]">
          ...
          <div className="absolute  left-4 right-4 md:left-8 md:top-20 md:right-8 md:p-6">
...
<div className="px-4 md:px-20 py-6
  relative md:absolute md:bottom-5 md:left-0 md:w-full
  border-t border-white/30">        <div className="max-w-[1342px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-sm opacity-90">
