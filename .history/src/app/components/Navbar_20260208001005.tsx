...
const Navbar: React.FC = () => {
  ...
  return (
<nav className="fixed top-10 mx-4 max-w-[371px] left-1/2 -translate-x-1/2 z-50 rounded-[20px] bg-[#C1C2C266] backdrop-blur-[50px] px-5 py-7 flex items-center justify-between md:bg-transparent md:max-w-[1311px]">
